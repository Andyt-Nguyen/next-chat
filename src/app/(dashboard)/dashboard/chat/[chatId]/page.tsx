...
const page = async ({ params }: pageProps) => {
  ...
  const initalMsgs = await getChatMessages(chatId)
  ...
  return <div className='flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-6rem)]'>
    ...
    <Messages chatId={chatId} sessionImage={user.image} chatPartner={chatPartner} sessionId={user.id} initialMessages={initalMsgs} />
